...
import bslib.common.EventArgs;
import bslib.common.EventHandler;
...
public class VirtualTable extends JPanel
{
    ...
    private EventHandler fOnSelectionChange;
        ...
        this.fTable = new JTable(fModel)
        {
            ...
            public Component prepareRenderer(TableCellRenderer renderer, int row, int column)
            {
                ...
                if (!isRowSelected(row)) {
                    prepareRendererComponent(renderer, c, row, column);
                }
                return c;
            }
        };
        ...
        fTable.getSelectionModel().addListSelectionListener(new ListSelectionListener()
        {
            ...
            public void valueChanged(ListSelectionEvent event)
            {
                ...
                if (fOnSelectionChange != null) {
                    fOnSelectionChange.invoke(new EventArgs(this));
                }
            }
        });
    ...
    protected void prepareRendererComponent(TableCellRenderer renderer, Component rendererComponent, int row, int column)
    {
        //return null;
    }
    ...
    public EventHandler getOnSelectionChange()
    {
        return this.fOnSelectionChange;
    }

    public void setOnSelectionChange(EventHandler value)
    {
    ...
    /**
     * Sets the preferred width of the visible column specified by colIndex. The
     * column will be just wide enough to show the column head and the widest
    ...
    public void addColumn(String columnName, int width)
    {
        ...
        int lastIndex = colModel.getColumnCount();

        DefaultTableModel defModel = (DefaultTableModel) this.fModel;
        defModel.addColumn(columnName);

        TableColumn column = colModel.getColumn(lastIndex);
        column.setHeaderValue(columnName);
        column.setPreferredWidth(width);
    }

    public final void setColumnCaption(int index, String caption)
    {
        if (this.fVirtualMode) {
            return;
        }
    ...
    /**
     * Removes an <code>ActionListener</code> from the VirtualTable. If the
